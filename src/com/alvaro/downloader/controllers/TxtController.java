...
import com.alvaro.downloader.views.TxtDlMenu;
...
public class TxtController {
    ...
    public final TxtDlMenu MENU;

    public TxtController(String headerText, MainController parent) {
        MENU = new TxtDlMenu(headerText);
        PARENT = parent;
    }
    ...
    public void start() {
        ...
        Main.downloadService.execute(() -> {
            var download = new TextDownload(fileName, url);
